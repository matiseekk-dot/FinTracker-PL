...
const BASE_CATEGORIES = [
  ...
  { id: "dodatkowe",    label: "Dodatkowe",      icon: DollarSign, color: "#a3e635", group: "income" },
...
const XTB_PORTFOLIO = [
  // Konto inwestycyjne
  { ticker: "IWDA.AS", name: "iShares MSCI World",      type: "ETF",    account: "zwykłe",
      ...
      <Card style={{ marginBottom: 14 }}>
        ...
        <ResponsiveContainer width="100%" height={110}>
          <AreaChart data={histPerf}>
            ...
            <XAxis dataKey="m" tick={{ fill: "#475569", fontSize: 13 }} axisLine={false} tickLine={false}/>
            <Tooltip contentStyle={{ background: "#0d1628", border: "1px solid #1a2744", borderRadius: 10, fontSize: 13 }} formatter={v => [fmt(v), "Wartość"]}/>
